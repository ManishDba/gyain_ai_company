...
const PieChartComponent = ({ title, chartData }) => {
  ...
  const negativeTotal = negativeData.reduce(
        ...
        <View style={styles.pieLegendContainer}>
          {transformedData.map((item, index) => (
            <View key={index} style={styles.pieLegendItem}>
              ...
              />
              <Text style={styles.pieLegendText}>{item.fullText}</Text>
            </View>
          ))}
        </View>
        ...
        <View style={styles.pieChartWrapper}>
          ...
          {selectedSlice && (
            <View style={styles.tooltip}>
              <View
                style={[styles.dot, { backgroundColor: selectedSlice.color }]}
              />
...
const MultiLineChartComponent = ({ title, chartData }) => {
  if (
    ...
    !chartData.data.every(ds => ds.color && ds.label && Array.isArray(ds.data))
  ) {
